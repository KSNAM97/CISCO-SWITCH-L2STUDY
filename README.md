...
| # | 실습 | 핵심 주제 |
| --- | --- | --- |
| Lab 01 | [VTP 4-Switch 동기화](./labs/lab01_vtp-4switch/README.md) | Server / Client / Transparent Mode 동작 검증 |
| Lab 02 | [STP Block Port 제어 (2 SW)](./labs/lab02_stp-blockport/README.md) | VLAN별 경로 분리 (Port-Priority / Cost) |
